...
$(document).ready(function() {
      ...
      table = $('#table').DataTable({
          ...
          "ajax": {
              "url": "<?php echo base_url('admin/pengembalian/ajax_list')?>/" + id_panjar,
              "type": "POST"
          },
...
//Change Option Kegiatan, otomatis hitung sisa
$('[name="option_kegiatan"]').change(function(){
  if ($(this).val() != '') {
  var id_panjar = $(this).val();
  $.ajax({
...
$('#tambah-pengembalian').click(function(){
      ...
      $.ajax({
          url : "<?php echo base_url('bendahara/pengembalian/option_kegiatan')?>",
          type: "GET",
          dataType: "JSON",
          success: function(data)
          {
...
function edit_pengembalian(id_pengembalian)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $.ajax({
                url : "<?php echo base_url('bendahara/pengembalian/option_kegiatan_edit')?>/"+ data.id_kegiatan,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
